...
<head>
    ...
    <!-- TODO: ファビコンを追加する -->
    <link rel="stylesheet" href="<?= BASE_URL ?>css/styles.css?v=32">
</head>
<body class="page-mypage">
    ...
    <main class="mypage-main">
        <div class="mypage-deck-grid">
            <!-- 新規登録カード -->
            <a href="<?= BASE_URL ?>View/deck/construction.php" class="mypage-deck-card new-deck-card">
            ...
            <div class="mypage-deck-card">
                ...
                <div class="mypage-deck-actions">
                    <a href="<?= BASE_URL ?>View/deck/construction.php?id=2" class="mypage-deck-button">編集</a>
            ...
            <div class="mypage-deck-card">
                ...
                <div class="mypage-deck-actions">
                    <a href="<?= BASE_URL ?>View/deck/construction.php?id=3" class="mypage-deck-button">編集</a>
            ...
            <div class="mypage-deck-card">
                ...
                <div class="mypage-deck-actions">
                    <a href="<?= BASE_URL ?>View/deck/construction.php?id=4" class="mypage-deck-button">編集</a>
            ...
            <div class="mypage-deck-card">
                ...
                <div class="mypage-deck-actions">
                    <a href="<?= BASE_URL ?>View/deck/construction.php?id=5" class="mypage-deck-button">編集</a>
            ...
            <div class="mypage-deck-card">
                ...
                <div class="mypage-deck-actions">
                    <a href="<?= BASE_URL ?>View/deck/construction.php?id=6" class="mypage-deck-button">編集</a>
            ...
            <div class="mypage-deck-card">
                ...
                <div class="mypage-deck-actions">
                    <a href="<?= BASE_URL ?>View/deck/construction.php?id=7" class="mypage-deck-button">編集</a>
            ...
            <div class="mypage-deck-card">
                ...
                <div class="mypage-deck-actions">
                    <a href="<?= BASE_URL ?>View/deck/construction.php?id=8" class="mypage-deck-button">編集</a>
            ...
            <div class="mypage-deck-card">
                ...
                <div class="mypage-deck-actions">
                    <a href="<?= BASE_URL ?>View/deck/construction.php?id=9" class="mypage-deck-button">編集</a>
